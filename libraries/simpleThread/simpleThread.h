...
// init thread system
	...
	#define simpleThread_init(cnt)\
		...
		PROGMEM prog_uint8_t  const  g_simpleThread_cnt  = cnt+1;\
...
// thread create
	...
	#define simpleThread_help_new_thread(id, name, status)\
		PROGMEM prog_uint8_t  const  g_simpleThread_id__##name  = id;\
	...
	#define simpleThread_new_timebased_dynamic(id, timebase, init_time, status, name)\
		simpleThread_help_new_thread(id, name, status);\
		PROGMEM prog_uint32_t  const  _simpleThread_time_default__##name  = init_time;\
